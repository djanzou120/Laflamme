<footer class="site-footer | focus-links" role="contentinfo">
    <!-- Groups -->
    <div class="site-footer__groups | container gutter | space-t--sm footercontainer">
        <div class="site-footer__groups__container">
            <!-- Contact -->
            <div class="site-footer__group">
                <div aria-label="Founders Pledge Contact Info" class="footer-contact">
                    <!-- Logo -->
                ...
                <span class="logo | icon">
                  <span class="logo | icon logoElat2">
                    ...
                    <div class="hcard | lg:py-0 py-8">
                        <div class="hcard__item | tel" style="margin-bottom: 7px; font-size: 14px;">
                            <a href="tel: +237 208 068 0425">+237 208 068 0425</a>
                        </div>

                        <div class="hcard__item | email" style="margin-bottom: 7px; font-size: 14px;">
                            <a href="mailto:info@founderspledge.com">info@xxx.com</a>
                        </div>
            ...
            <!-- Footer Menu -->
            <div class="site-footer__group">
                <nav aria-label="Founders Pledge Main Footer Menu" class="footer-menu" id="footer-menu-main">
                    <h5 class="site-footer__header | header-">Informations</h5>

                    <ul class="menu-list">
                        <li class="menu-list__item">
                            <a role="menuitem" aria-haspopup="false" href="{{route('blog')}}"  tabindex="0">
                                Blog
                            </a>
                        </li>
                        <li class="menu-list__item">
                            <a role="menuitem" aria-haspopup="false" href="{{route('forum')}}" tabindex="0">
                                Forum
                            </a>
                        </li>
                        <li class="menu-list__item">
                            <a role="menuitem" aria-haspopup="false" href="{{route('about')}}"  tabindex="0">
                                A Propos
                            </a>
                        </li>
                    </ul>
            ...
            <div class="site-footer__group">
                <nav aria-label="Founders Pledge Main Footer Menu" class="footer-menu" id="footer-menu-main">
                    <h5 class="site-footer__header | header-">Nous Contacter</h5>
                    <ul class="menu-list">
                        <li class="menu-list__item">
                            <a role="menuitem" aria-haspopup="false" href="{{route('contact')}}"
                               tabindex="0">
                                Contact</a>
                        </li>
                        <li class="menu-list__item">
                            <a role="menuitem" aria-haspopup="false" href="{{route('login')}}"
                               tabindex="0">
                                Connexion
                            </a>
                        </li>
                        <li class="menu-list__item">
                            <a role="menuitem" aria-haspopup="false" href="{{route('register')}}" tabindex="0">
                                S'inscrire
                            </a>
                        </li>
                    </ul>
            ...
            <!-- Footer Menu -->
            <div class="site-footer__group">
                <nav aria-label="Founders Pledge Main Footer Menu" class="footer-menu" id="footer-menu-know-us">
                    <h5 class="site-footer__header | header-">Nous Connaitre</h5>
                    <ul class="social-list -flush-l" role="menubar">
                        <li>
                            <a href="https://www.facebook.com/elatbobenyan.association/" target="_blank" aria-label="Facebook"><span
      ...
      H12.46218z" />
                        ...
                        <li>
                            <a href="https://www.linkedin.com/in/elat-bobenyañ-7b93691b6" target="_blank" aria-label="Linked In"><span
      ...
      h0.06507c0.6328-1.20053,2.18142-2.46658,4.49049-2.46658c4.80551,0,5.6936,3.16196,5.6936,7.27476V27.26738z" />
                        ...
                        <li>
                            <a href="https://twitter.com/elatbobenyan/" target="_blank" aria-label="Linked In"><span
                                    class="icon | icon--linkedin "><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
